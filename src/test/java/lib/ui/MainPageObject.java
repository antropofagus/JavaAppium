...
public class MainPageObject {
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message) {
        if (driver instanceof AppiumDriver) {
           // AppiumDriver driver = (AppiumDriver) this.driver;
            ...
            System.out.println("Method clickElementToTheRightUpperCorner() does nothing for platforms: " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    public void scrollWebPageUp() {
        if(Platform.getInstance().isMW()) {
            ...
            System.out.println("Method scrollWebPageUp() does nothing for platforms: " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    protected void swipeElementToLeft(String locator, String error_message) {
        if (driver instanceof AppiumDriver) {
           // AppiumDriver driver = (AppiumDriver) this.driver;
            ...
            action.waitAction(waitOptions.withDuration(Duration.ofSeconds(30)));
...
//            }
            ...
            System.out.println("Method swipeElementToLeft() does nothing for platforms: " + Platform.getInstance().getPlatformVar());
        }
    }
